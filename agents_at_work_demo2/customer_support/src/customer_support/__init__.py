"""Customer support demo package setup."""
...
# Force CrewAI/ChromaDB to persist inside the project so the demo does not
# depend on a writable global AppData location.
